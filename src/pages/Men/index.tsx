...
const Men: FC = () => {
  return (
    ...
    <div className='flex flex-[1_1_65%] h-[300px] border-b-1 pb-6'>
      ...
      <p className="text-xs pl-6 pr-6 tracking-wider">There’s a new trend every year, but you don’t have to spend much time figuring it out. If you’re looking for what’s hot right now, then Perfumania has you covered with the best-selling men’s cologne. We stock the best scents from the greatest names in the business, and all of our top sellers are ready for you! From musk and woods to vibrant an</p>
    </div>
    <hr />
